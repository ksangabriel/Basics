...
public class InternalMCCompInterfaceView
  implements IPrivateMCCompInterfaceView, com.sap.tc.webdynpro.progmodel.gci.IGCIViewDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalMCCompInterfaceView.class);
   ...
   */
  private final com.kl.comp.MCCompInterfaceView delegate;
   ...
   */
  public InternalMCCompInterfaceView(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    this.wdAlterEgo = alterEgo;
    this.delegate = new com.kl.comp.MCCompInterfaceView((IPrivateMCCompInterfaceView) this);
  }
