...
public interface IPublicMCCompInterfaceCfg extends com.kl.comp.wdp.IExternalMCCompInterfaceCfg {
  ...
  {
    private InternalMCCompInterfaceCfg gen_delegate;

    IContextNode(InternalMCCompInterfaceCfg delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateMCCompInterfaceCfg.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateMCCompInterfaceCfg.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateMCCompInterfaceCfg.IContextElement createContextElement() {
      return (IPrivateMCCompInterfaceCfg.IContextElement)createElement();
    }
     ...
     */
    public void bind(IPrivateMCCompInterfaceCfg.IContextElement element) {
     ...
     */
    public IPrivateMCCompInterfaceCfg.IContextElement currentContextElement() {
      return (IPrivateMCCompInterfaceCfg.IContextElement) getCurrentElement();
    }
  ...
  public static class IContextElement extends com.sap.tc.webdynpro.progmodel.context.NodeElement
  {
    ...
    public IContextElement(InternalMCCompInterfaceCfg delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
