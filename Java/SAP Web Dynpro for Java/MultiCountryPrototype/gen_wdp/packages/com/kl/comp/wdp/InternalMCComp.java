...
public class InternalMCComp
  implements IPrivateMCComp, com.sap.tc.webdynpro.progmodel.gci.IGCIComponentDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalMCComp.class);
   ...
   */
  private final com.kl.comp.MCComp delegate;
...

  {
    ...
    infoAvailableCountriesList = GCIContext.createNode("AvailableCountriesList", com.kl.bean.CountryBean.class, true, false, true, false, false, true, null,
      new IGCIAttributeInfo[] {
        GCIContext.createAttribute("country", "ddic:com.sap.dictionary.string", null, "country", false, false),
        GCIContext.createAttribute("countryCode", "ddic:com.sap.dictionary.string", null, "countryCode", false, false),
      },
      (IGCINodeInfo[])null // no child nodes
    );

    infoAclUserCountriesList = GCIContext.createNode("AclUserCountriesList", com.kl.bean.CountryBean.class, true, false, true, false, false, true, null,
      new IGCIAttributeInfo[] {
        GCIContext.createAttribute("country", "ddic:com.sap.dictionary.string", null, "country", false, false),
        GCIContext.createAttribute("countryCode", "ddic:com.sap.dictionary.string", null, "countryCode", false, false),
      },
    ...
    infoAclUser = GCIContext.createNode("AclUser", com.kl.bean.CountryDao.class, true, false, true, false, false, true, null,
   ...
   */
  public InternalMCComp(com.sap.tc.webdynpro.progmodel.gci.IGCIComponent alterEgo) {
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.kl.comp.MCComp((IPrivateMCComp) this);
  }
