...
public class InternalMCCompInterfaceCfg
  implements IPrivateMCCompInterfaceCfg, com.sap.tc.webdynpro.progmodel.gci.IGCICustomControllerDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalMCCompInterfaceCfg.class);
   ...
   */
  private final com.kl.comp.MCCompInterfaceCfg delegate;
   ...
   */
  public InternalMCCompInterfaceCfg(com.sap.tc.webdynpro.progmodel.gci.IGCICustomController alterEgo) {
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.kl.comp.MCCompInterfaceCfg((IPrivateMCCompInterfaceCfg) this);
  }
  ...
  private class External
    implements com.sap.tc.webdynpro.progmodel.api.IWDExternalControllerInterface, IExternalMCCompInterfaceCfg
  {
