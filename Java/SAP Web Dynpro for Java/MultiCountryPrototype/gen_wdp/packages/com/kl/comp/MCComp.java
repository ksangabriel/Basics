...
// AT LEAST ONE IMPORT STATEMENT (E.G. THAT FOR IPrivateMCComp).
// OTHERWISE, USING THE ECLIPSE FUNCTION "Organize Imports" FOLLOWED BY
// A WEB DYNPRO CODE GENERATION (E.G. PROJECT BUILD) WILL RESULT IN THE LOSS
// OF IMPORT STATEMENTS.
//
//@@begin imports
import com.kl.comp.wdp.IPrivateMCComp;
//@@end
...
public class MCComp
{
  ...
  private static final com.sap.tc.logging.Location logger = 
    com.sap.tc.logging.Location.getLocation(MCComp.class);
   ...
   * component usages.
   *
   * @see com.kl.comp.wdp.IPrivateMCComp for more details
   */
  private final IPrivateMCComp wdThis;
   ...
   *
   * @see com.kl.comp.wdp.IPrivateMCComp.IContextNode for more details.
   */
  private final IPrivateMCComp.IContextNode wdContext;
  ...
  public MCComp(IPrivateMCComp wdThis)
  {
    this.wdThis = wdThis;
