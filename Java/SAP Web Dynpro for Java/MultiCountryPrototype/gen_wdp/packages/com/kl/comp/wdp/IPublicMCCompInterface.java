...
public interface IPublicMCCompInterface extends com.kl.comp.wdp.IExternalMCCompInterface {
  ...
  {
    private InternalMCCompInterface gen_delegate;

    IContextNode(InternalMCCompInterface delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateMCCompInterface.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateMCCompInterface.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateMCCompInterface.IContextElement createContextElement() {
      return (IPrivateMCCompInterface.IContextElement)createElement();
    }
     ...
     */
    public void bind(IPrivateMCCompInterface.IContextElement element) {
     ...
     */
    public IPrivateMCCompInterface.IContextElement currentContextElement() {
      return (IPrivateMCCompInterface.IContextElement) getCurrentElement();
    }
  ...
  public static class IContextElement extends com.sap.tc.webdynpro.progmodel.context.NodeElement
  {
    ...
    public IContextElement(InternalMCCompInterface delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
