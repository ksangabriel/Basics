...
public class InternalMCCompInterface
  implements IPrivateMCCompInterface, com.sap.tc.webdynpro.progmodel.gci.IGCICustomControllerDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalMCCompInterface.class);
   ...
   */
  private final com.kl.comp.MCCompInterface delegate;
   ...
   */
  public InternalMCCompInterface(com.sap.tc.webdynpro.progmodel.gci.IGCICustomController alterEgo) {
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.kl.comp.MCCompInterface((IPrivateMCCompInterface) this);
  }
  ...
  private class External
    implements com.sap.tc.webdynpro.progmodel.api.IWDExternalControllerInterface, IExternalMCCompInterface
  {
